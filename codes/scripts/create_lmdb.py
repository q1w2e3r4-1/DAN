...
if __name__ == '__main__':
    ...
    # img_folder = "../../data/gong1024/HR/x4/*"
    # lmdb_save_path = "../../data/gong1024/gong.lmdb"
    # meta_info = {"name": "gong1024"}

    img_folder = "../../data/chase256/HR/x4/*"
    lmdb_save_path = "../../data/chase256/chase.lmdb"
    meta_info = {"name": "chase256"}
